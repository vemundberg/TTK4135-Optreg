...
t = q_01.ans(1,:);
u_01 = q_01.ans(3,:)+2*pi;
u_1 = q_1.ans(3,:)+2*pi;
u_10 = q_10.ans(3,:)+2*pi;
...
grid on, xlabel('t[s]'), ylabel('\lambda [rad]'), legend('\lambda_{q = 0.1}','\lambda_{q = 1}','\lambda_{q = 10}'), title('\lambda with no feedback');
